# ******************************************************************************************
# FileName     : SmartEnv_SmartLabOn.py
# Description  : 스마트 환경 코딩 키트 - 온습도, 미세먼지, 산소, 이산화탄소, 소음 센서
# Author       : 박은정
# Created Date : 25.08.04 : 박은정
# Modified     : 
# ******************************************************************************************
...
RMS_DB_DATA = [
    (1.7, 39.9), (2.1, 40.3), (3.5, 44.5), (7.4, 55.0), (8.31, 57.5),
    (13.9, 76.5), (20.4, 80.4), (29.3, 90.6), (31.8, 93.9)
]
...
#===========================================================================================
    ...
    for sensor in sensors:
        payload = json_to_unicode_escaped(sensor)
